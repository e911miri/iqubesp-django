...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'operations_course', 'prerequisites',
                      self.gf('django.db.models.fields.TextField')(default='A Computer'),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Course.prerequisites'
        db.delete_column(u'operations_course', 'prerequisites')
